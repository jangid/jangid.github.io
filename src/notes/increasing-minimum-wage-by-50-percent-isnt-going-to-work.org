...
#+DATE: 2016-08-23
#+DESCRIPTION: If a 50% minimum wage hike is good, why not 500%? Walking through the downstream effects on employers, employment, and prices that well-meaning wage policy tends to ignore.
