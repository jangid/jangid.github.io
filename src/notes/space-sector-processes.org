...
#+DATE: 2026-03-09
#+DESCRIPTION: India's space startups are building rockets and satellites. The harder problem -- and the one that separates a capable ecosystem from a headline one -- is building the processes that make them work reliably.
#+FILETAGS: :governance:india:
#+OPTIONS: toc:nil
